#!/usr/bin/env bb
;; hagukumi 育み — ingest seed.edn into a live kotoba node (cljc port of ingest_mcp.py).
;; ADR-2605261030.
(ns hagukumi.kotoba.ingest-mcp
  "hagukumi 育み — MCP seed-ingest scaffold (dry-run default, live path placeholder).
  ADR-2605261030. Template: see funadaiku.kotoba.ingest-mcp."
  (:require [kotoba.lang.text :as str]
            #?(:clj [clojure.java.io :as io])))

(def default-url   "http://127.0.0.1:8077")
(def default-graph "com.etzhayyim.hagukumi")
