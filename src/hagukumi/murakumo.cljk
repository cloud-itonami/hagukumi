...
(defn collection
  [name]
  (str "com.etzhayyim.hagukumi." name))

(def cell-specs {
  :child_daily_care {:legacy-cell "child-daily-care"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "child_daily_care")]
     :required-gates common-gates
     :trigger "manifest cell child_daily_care"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :elder_companionship {:legacy-cell "elder-companionship"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "elder_companionship")]
     :required-gates common-gates
     :trigger "manifest cell elder_companionship"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :chronic_continuity {:legacy-cell "chronic-continuity"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "chronic_continuity")]
     :required-gates common-gates
     :trigger "manifest cell chronic_continuity"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :meal_delivery {:legacy-cell "meal-delivery"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "meal_delivery")]
     :required-gates common-gates
     :trigger "manifest cell meal_delivery"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :respite_support {:legacy-cell "respite-support"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "respite_support")]
     :required-gates common-gates
     :trigger "manifest cell respite_support"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
